...
async function initMap() {
  ...
  const { AdvancedMarkerElement } = await google.maps.importLibrary("marker");
    ...
    const allEvening = new google.maps.MarkerImage("public/media/svg/Marker_Red.svg", null, null, null, new google.maps.Size(50, 50));
    const opningHours = new google.maps.MarkerImage("public/media/src/svg/Marker_blue.svg", null, null, null, new google.maps.Size(50, 50));
    const popUp = new google.maps.MarkerImage("public/media/src/svg/Marker_orange.svg", null, null, null, new google.maps.Size(50, 50));
